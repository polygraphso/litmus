...
## Verify before you trust (at runtime)
...
> is the disclosed residual limit. Keep your own runtime guards on (e.g. transaction-verification
> checks before signing or paying), even for an A.
...
- **References:** [`methodology.md`](references/methodology.md) · [`cli.md`](references/cli.md) · [`ci-gate.md`](references/ci-gate.md)
